...
.. deprecated:: 6.0
   ...
   See :ref:`isaacsim_sensors_physx_lidar_migration` for step-by-step migration instructions, or the `isaacsim.sensors.experimental.physics API Documentation <../py/source/extensions/isaacsim.sensors.experimental.physics/docs/index.html>`_ for the replacement APIs.
