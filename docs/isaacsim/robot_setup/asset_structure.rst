...
Each asset is broken down into multiple components, which can be categorized as follows:
...
.. image:: /images/isim_6.0_full_ref_external_asset-file-structure.png
    :align: center
    :width: 100%
    :alt: File Structure for the Inspire Hand asset
...
.. image:: /images/isim_6.0_full_ref_external_asset-file-structure.png
    :align: center
    :width: 100%
    :alt: isim_6.0_full_ref_external_asset-file-structure.png
...
.. image:: /images/isim_6.0_full_ref_external_asset-diagram.png
    :align: center
    :width: 100%
    :alt: isim_6.0_full_ref_external_asset-diagram.png
