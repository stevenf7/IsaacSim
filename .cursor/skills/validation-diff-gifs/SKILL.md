...
```bash
bash .cursor/skills/validation-diff-gifs/scripts/generate_diff_gifs.sh \
    <captured_run_dir> \
...
bash .cursor/skills/validation-diff-gifs/scripts/generate_diff_gifs.sh "$LATEST" "$GOLDEN"
```
