...
function create_tests()
    ...
    group "python_samples"
        ...
        python_sample_test("tests-nativepython-testing-omni.isaac.core.hello_world", "standalone_examples/testing/omni.isaac.core/hello_world.py", "--test")
        python_sample_test("tests-nativepython-testing-omni.isaac.core.test_time_stepping", "standalone_examples/testing/omni.isaac.core/test_time_stepping.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.core.test_articulation_root", "standalone_examples/testing/omni.isaac.core/test_articulation_root.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.core.test_fabric_frame_delay", "standalone_examples/testing/omni.isaac.kit/test_fabric_frame_delay.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.core.test_rendering", "standalone_examples/testing/omni.isaac.core/test_rendering.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.core.test_save_stage", "standalone_examples/testing/omni.isaac.core/test_save_stage.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.core.test_delete_in_contact", "standalone_examples/testing/omni.isaac.core/test_delete_in_contact.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.core.test_articulation_determinism", "standalone_examples/testing/omni.isaac.core/test_articulation_determinism.py")
        ...
        python_sample_test("tests-nativepython-testing-omni.isaac.core.tensor_api_handles", "standalone_examples/testing/omni.isaac.core/tensor_api_handles.py")
