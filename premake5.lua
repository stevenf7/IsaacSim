...
function include_extensions()
    ...
    include ("source/extensions/isaacsim.replicator")
...
function create_tests()
    ...
    group "python_samples"
        ...
        python_sample_test("tests-nativepython-testing-isaacsim.replicator.custom_event_and_write", "/standalone_examples/api/isaacsim.replicator/custom_event_and_write.py")
        python_sample_test("tests-nativepython-testing-isaacsim.replicator.motion_blur", "/standalone_examples/api/isaacsim.replicator/motion_blur.py")
        python_sample_test("tests-nativepython-testing-isaacsim.replicator.subscribers_and_events", "/standalone_examples/api/isaacsim.replicator/subscribers_and_events.py")
        python_sample_test("tests-nativepython-testing-isaacsim.replicator.custom_fps_writer_annotator", "/standalone_examples/api/isaacsim.replicator/custom_fps_writer_annotator.py")
        python_sample_test("tests-nativepython-testing-isaacsim.replicator.multi-camera", "standalone_examples/api/isaacsim.replicator/multi-camera.py")
        python_sample_test("tests-nativepython-testing-isaacsim.replicator.simulation_get_data", "standalone_examples/api/isaacsim.replicator/simulation_get_data.py")
