...
function create_tests()
    ...
    group "internal_python_samples"
        ...
        python_sample_test("tests-internalnativepython-omni.replicator.isaac.custom_event_and_write", "/standalone_examples/api/omni.replicator.isaac/custom_event_and_write.py")
