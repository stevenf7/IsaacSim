...
function include_extensions()
    ...
    include ("source/extensions/omni.isaac.grasp_editor")
    ...
    include ("source/extensions/omni.isaac.ros2_bridge.robot_description")
...
function create_tests()
    ...
    group "python_samples"
        ...
        python_sample_test("tests-nativepython-testing-isaacsim.core.api.test_fabric_frame_delay", "standalone_examples/testing/omni.isaac.kit/test_fabric_frame_delay.py")
        ...
        python_sample_test("tests-nativepython-testing-isaacsim.ros2.bridge.enable_extension", "standalone_examples/testing/omni.isaac.ros2_bridge/enable_extension.py")
        python_sample_test("tests-nativepython-testing-isaacsim.ros2.bridge.test_carter_camera_multi_robot_nav", "standalone_examples/testing/omni.isaac.ros2_bridge/test_carter_camera_multi_robot_nav.py")
        python_sample_test("tests-nativepython-testing-isaacsim.ros2.bridge.test_people_sim", "standalone_examples/testing/omni.isaac.ros2_bridge/test_people_sim.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.kit.test_extra_args", "standalone_examples/testing/omni.isaac.kit/test_extra_args.py", '--/persistent/isaac/asset_root/default="omniverse://ov-test-this-is-working"')
        python_sample_test("tests-nativepython-testing-omni.isaac.kit.test_frame_delay_basic", "standalone_examples/testing/omni.isaac.kit/test_frame_delay.py", "--/app/renderer/waitIdle=true --/app/hydraEngine/waitIdle=true")
        python_sample_test("tests-nativepython-testing-omni.isaac.kit.test_frame_delay_under_load", "standalone_examples/testing/omni.isaac.kit/test_frame_delay.py", "--/app/renderer/waitIdle=true --/app/hydraEngine/waitIdle=true --env-url /Isaac/Environments/Simple_Warehouse/full_warehouse.usd --num-additional-render-products 8")
        python_sample_test("tests-nativepython-testing-omni.isaac.kit.test_ogn", "standalone_examples/testing/omni.isaac.kit/test_ogn.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.kit.test_syntheticdata", "standalone_examples/testing/omni.isaac.kit/test_syntheticdata.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.kit.test_fetch_results", "standalone_examples/testing/omni.isaac.kit/test_fetch_results.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.kit.test_unsaved_on_exit", "standalone_examples/testing/omni.isaac.kit/test_unsaved_on_exit.py")
        ...
        python_sample_test("tests-nativepython-testing-omni.isaac.kit.test_external", "standalone_examples/testing/omni.isaac.kit/test_external.py", '--enable omni.kit.scripting')
        python_sample_test("tests-nativepython-testing-omni.isaac.ros_bridge.test_carter_lidar", "standalone_examples/testing/omni.isaac.ros_bridge/test_carter_lidar.py", "--test")
        python_sample_test("tests-nativepython-testing-omni.isaac.cortex.bringup", "standalone_examples/testing/omni.isaac.cortex/cortex_bringup_test.py")
        ...
        python_sample_test("tests-nativepython-testing-omni.replicator.isaac.custom_event_and_write", "/standalone_examples/api/omni.replicator.isaac/custom_event_and_write.py")
        python_sample_test("tests-nativepython-testing-omni.replicator.isaac.motion_blur", "/standalone_examples/api/omni.replicator.isaac/motion_blur.py")
        python_sample_test("tests-nativepython-testing-omni.replicator.isaac.subscribers_and_events", "/standalone_examples/api/omni.replicator.isaac/subscribers_and_events.py")
        python_sample_test("tests-nativepython-testing-omni.replicator.isaac.custom_fps_writer_annotator", "/standalone_examples/api/omni.replicator.isaac/custom_fps_writer_annotator.py")
        python_sample_test("tests-nativepython-testing-omni.replicator.isaac.multi-camera", "standalone_examples/api/omni.replicator.isaac/multi-camera.py")
        python_sample_test("tests-nativepython-testing-omni.replicator.isaac.simulation_get_data", "standalone_examples/api/omni.replicator.isaac/simulation_get_data.py")
