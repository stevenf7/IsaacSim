...
group "apps"
    ...
    define_local_experience("isaac-sim.startup", "omni.isaac.sim.startup", "--/app/quitAfter=500")
...
group "python_samples"
    ...
    python_sample_test("tests-python.simple.franka_rmp", "simple/franka_rmp.py", "--headless")
    -- SDK samples 
