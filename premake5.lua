...
function include_extensions()
    ...
    include ("source/extensions/isaacsim.asset.generator.occupancy_map.ui")
    include ("source/extensions/isaacsim.asset.generator.occupancy_map")
    ...
    include ("source/extensions/isaacsim.replicator.common")
...
function create_tests()
    ...
    group "python_samples"
        ...
        python_sample_test("tests-nativepython-testing-isaacsim.replicator.common.custom_event_and_write", "/standalone_examples/api/isaacsim.replicator.common/custom_event_and_write.py")
        python_sample_test("tests-nativepython-testing-isaacsim.replicator.common.motion_blur", "/standalone_examples/api/isaacsim.replicator.common/motion_blur.py")
        python_sample_test("tests-nativepython-testing-isaacsim.replicator.common.subscribers_and_events", "/standalone_examples/api/isaacsim.replicator.common/subscribers_and_events.py")
        python_sample_test("tests-nativepython-testing-isaacsim.replicator.common.custom_fps_writer_annotator", "/standalone_examples/api/isaacsim.replicator.common/custom_fps_writer_annotator.py")
        python_sample_test("tests-nativepython-testing-isaacsim.replicator.common.multi-camera", "standalone_examples/api/isaacsim.replicator.common/multi-camera.py")
        python_sample_test("tests-nativepython-testing-isaacsim.replicator.common.simulation_get_data", "standalone_examples/api/isaacsim.replicator.common/simulation_get_data.py")
