...
function create_tests()
    ...
    group "python_samples"
        ...
        python_sample_test("tests-nativepython-testing-omni.isaac.gym.test_gym_headless_app", "standalone_examples/testing/omni.isaac.gym/test_gym_headless_app.py")
