...
function include_extensions()
    ...
    include ("source/extensions/omni.isaac.tf_viewer")
...
function create_tests()
    ...
    group "python_samples"
        ...
        python_sample_test("tests-nativepython-testing-omni.isaac.ros2_bridge.enable_extension", "standalone_examples/testing/omni.isaac.ros2_bridge/enable_extension.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.ros2_bridge.test_carter_camera_multi_robot_nav", "standalone_examples/testing/omni.isaac.ros2_bridge/test_carter_camera_multi_robot_nav.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.ros2_bridge.test_people_sim", "standalone_examples/testing/omni.isaac.ros2_bridge/test_people_sim.py")
        ...
        python_sample_test("tests-nativepython-testing-omni.isaac.benchmark.services.test_no_rendering", "standalone_examples/testing/omni.isaac.benchmark.services/test_no_rendering.py")
        ...
        python_sample_test("tests-nativepython-testing-omni.isaac.sensor.contact_sensor", "standalone_examples/testing/omni.isaac.sensor/contact_sensor_test.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.sensor.camera_opencv_fisheye", "standalone_examples/api/omni.isaac.sensor/camera_opencv_fisheye.py")
        python_sample_test("tests-nativepython-testing-omni.isaac.sensor.camera_opencv", "standalone_examples/api/omni.isaac.sensor/camera_opencv.py")
