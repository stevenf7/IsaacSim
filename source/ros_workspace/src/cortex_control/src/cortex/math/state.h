...
public:
    ...
    Eigen::Ref<Eigen::VectorXd> pos()
    {
        return state.head(dim());
    }
    Eigen::Ref<Eigen::VectorXd> vel()
    {
        return state.tail(dim());
    }
    Eigen::Ref<Eigen::VectorXd> vector()
    {
        return state;
    }
    ...
    Eigen::Ref<const Eigen::VectorXd> vel() const
    {
        return state.tail(dim());
    }
    Eigen::Ref<const Eigen::VectorXd> vector() const
    {
        return state;
    }
