                                       ...
                                       bool validate_interpolation_evals)
{
    ...
    for (int i = 0; i < p0.dim(); ++i)
    {
        trajectories.push_back(
            interp1d_t(PosVelAcc1d::Slice(p0, i), PosVelAcc1d::Slice(p1, i), validate_interpolation_evals));
    }
    return trajectories;
}
...
public:
    ...
    MultiDimInterp(const PosVelAcc<vec_t>& p0, const PosVelAcc<vec_t>& p1, bool validate_interpolation_evals = false)
        : MultiDimTraj<interp1d_t, vec_t>(MakeDimInterps<interp1d_t, vec_t>(p0, p1, validate_interpolation_evals))
    {
    }
...
public:
    ...
    VectorXx operator()(double t) const
    {
        return Eval(t).x;
    }
...
public:
    ...
    VectorXx operator()(double t) const
    {
        return CentralFdVel(traj_, t, dt_);
    }
...
template <class traj1d_t, class vec_t>
bool MultiDimTraj<traj1d_t, vec_t>::Eval(double t, PosVelAcc<vec_t>& ret, std::string* error_str) const
{
