...
public:
    ...
    // 1, respectively.
    CubicPositionInterpolator1d(const PosVelAcc1d& p0, const PosVelAcc1d& p1, bool validate_interpolation_evals = false);
...
MultiDimInterp<CubicPositionInterpolator1d, vec_t> CubicInterpolator(const PosVelAcc<vec_t>& p0,
