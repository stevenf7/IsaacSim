...
public:
    ...
    // 1, respectively.
    QuinticInterpolator1d(const PosVelAcc1d& p0, const PosVelAcc1d& p1, bool validate_interpolation_evals = false);
...
MultiDimInterp<QuinticInterpolator1d, vec_t> QuinticInterpolator(const PosVelAcc<vec_t>& p0,
