...
public:
    ...
    // 1, respectively.
    QuarticInterpolator1d(const PosVelAcc1d& p0, const PosVelAcc1d& p1, bool validate_interpolation_evals = false);
...
MultiDimInterp<QuarticInterpolator1d, vec_t> QuarticInterpolator(const PosVelAcc<vec_t>& p0,
