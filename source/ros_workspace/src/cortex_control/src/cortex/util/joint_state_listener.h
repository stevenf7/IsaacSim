...
public:
     ...
     */
    void Init(const std::string& topic, const std::vector<std::string>& required_joints, int poll_rate);
     ...
     */
    StampedState State() const override
    {
        return CurrentState();
    }
     ...
     */
    const std::vector<std::string>& required_joints() const
    {
        return required_joints_;
    }
