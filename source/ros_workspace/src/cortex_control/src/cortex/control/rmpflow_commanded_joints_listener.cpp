...
RmpflowCommandedJointsListener::RmpflowCommandedJointsListener(const std::string& rmpflow_commands_topic,
      ...
      joint_state_listener_(std::make_shared<util::JointStateListener>())
{
    ...
    rmpflow_commands_listener_.RegisterCallback(
        [&](const auto& msg)
        {
...
const std::shared_ptr<util::JointStateListener> RmpflowCommandedJointsListener::joint_state_listener() const
{
