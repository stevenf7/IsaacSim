...
carb.log_warn(
    f"{old_extension_name}.datarecorders.interfaces has been deprecated in favor of {new_extension_name}.datarecorders.interfaces. Please update your code accordingly."
)
