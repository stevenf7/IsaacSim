...
#include <OgnIsaacCreateRTXLidarScanBufferNewDatabase.h>
#include <cmath>
#include <cstdint>
#include <cstring>
...
class OgnIsaacCreateRTXLidarScanBufferNew : public isaacsim::core::includes::BaseResetNode
{
private:
...
public:
    ...
    bool initialize(OgnIsaacCreateRTXLidarScanBufferNewDatabase& db)
    {
    ...
    static void resetOutputs(OgnIsaacCreateRTXLidarScanBufferNewDatabase& db)
    {
    ...
    static bool compute(OgnIsaacCreateRTXLidarScanBufferNewDatabase& db)
    {
        CARB_PROFILE_ZONE(0, "[IsaacSim] Create RTX Lidar Scan Buffer");
        db.outputs.exec() = kExecutionAttributeStateEnabled;
        auto& state = db.perInstanceState<OgnIsaacCreateRTXLidarScanBufferNew>();
