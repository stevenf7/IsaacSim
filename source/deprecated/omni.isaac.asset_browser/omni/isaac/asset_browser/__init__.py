...
#
# from isaacsim.asset.browser.extension import AssetBrowserExtension, get_instance
import carb

old_extension_name = "omni.isaac.asset_browser"
...
from isaacsim.asset.browser import *
