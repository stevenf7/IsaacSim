...
def tick_carter_ros_components(robot_num):
    omni.kit.commands.execute("Ros2BridgeTickComponent", path=f"/World/Carter_ROS_{robot_num}/ROS_Lidar")
    omni.kit.commands.execute("Ros2BridgeTickComponent", path=f"/World/Carter_ROS_{robot_num}/ROS_DifferentialBase")
    omni.kit.commands.execute(
        "Ros2BridgeTickComponent", path=f"/World/Carter_ROS_{robot_num}/ROS_Carter_Sensors_Broadcaster"
    )
    omni.kit.commands.execute("Ros2BridgeTickComponent", path=f"/World/Carter_ROS_{robot_num}/ROS_Carter_Broadcaster")
    omni.kit.commands.execute("Ros2BridgeTickComponent", path=f"/World/Carter_ROS_{robot_num}/ROS_Camera_Stereo_Left")
