...
if __name__ == "__main__":
    ...
    if test_mode:
        ...
        import ar_sdg_test_utils as test_utils

        golden_root_folder = os.path.join(os.path.dirname(os.path.abspath(__file__)), "data", "golden")
        output_root_folder = output_path
        num_render_products = 3
        # Raise exception in case a difference is found (exception is needed for CI testing)
        raise_exception = True
        # Print to console if the data is identical (useful for debugging)
