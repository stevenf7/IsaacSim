...
# Add a distant light
light_prim = UsdLux.DistantLight.Define(stage, Sdf.Path("/DistantLight"))
light_prim.CreateIntensityAttr(500)

if ENABLE_PHYSICS:
    # Create a ground plane
    PhysicsSchemaTools.addGroundPlane(stage, "/World/groundPlane", "Z", 1000, Gf.Vec3f(0, 0, -1.0), Gf.Vec3f(1.0))
