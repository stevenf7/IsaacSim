...
PYBIND11_MODULE(_occupancy_map, m)
{
    ...
    //     Assuming the stage has collision geometry information, the following code can be used to generate the
    //     occupancy map information
    ...
    //                 arg3 (:obj:`float`): Value used to denote unknown areas that could not be reached from the
    //                 starting location
    ...
    //             Main function that generates a map based on the settings and transform set. Assumes that a 2d map is
    //             generated and flattens the computed data
    //     )pbdoc")
    //     .def("generate3d", &MapGenerator::generate3d, R"pbdoc(
    //             Main function that generates a map based on the settings and transform set. Assumes 3d generation,
    //             output is not flattened
    //     )pbdoc")
    //     .def("get_occupied_positions", &MapGenerator::getOccupiedPositions, R"pbdoc(

    //             Returns:
    //                 :obj:`list` of :obj:`carb.Float2`: List of 2d points in stage coordinates containing occupied
    //                 locations.
    //     )pbdoc")
    //     .def("get_free_positions", &MapGenerator::getFreePositions, R"pbdoc(
    //             Returns:
    //                 :obj:`list` of :obj:`carb.Float2`: List of 2d points in stage coordinates containing free
    //                 locations.
    //     )pbdoc")
    ...
    //                 arg2 (:obj:`carb.Int4`): RGBA Value used to denote unknown areas that could not be reached from
    //                 the starting location
    //             Returns:
    //                 :obj:`list` of :obj:`int`: Flattened buffer containing list of RGBA values for each pixel. Can be
    //                 used to render as image directly
    //     )pbdoc");
