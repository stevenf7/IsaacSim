...
class TestOmniIsaacGymEnvsTrainFullGG(utils.OmniIsaacGymEnvsTestCase):
    ...
    async def test_factory_nut_bolt_pick_train_gg(self):
        experiment_name = utils._run_rlgames_train(utils.RLGAMES_SCRIPT, "FactoryTaskNutBoltPick", "gpu", "gpu", 150)
...
class TestOmniIsaacGymEnvsTrainFullGGMT(utils.OmniIsaacGymEnvsTestCase):
    ...
    async def test_factory_nut_bolt_pick_train_gg(self):
        experiment_name = utils._run_rlgames_train(utils.RLGAMES_SCRIPT_MT, "FactoryTaskNutBoltPick", "gpu", "gpu", 150)
        self._test_factory_nut_bolt_pick_train(experiment_name)
