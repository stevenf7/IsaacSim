...
project_ext_plugin(ext, "isaacsim.util.debug_draw.plugin")
    ...
    links {
        "gf", "tf", "sdf", "vt","usd", "usdGeom", "usdUtils", "usdShade", "usdImaging", "omni.usd", "isaacsim.util.debug_draw.primitive_drawing"
    }
...
project_ext_bindings ({
    ...
    links {"arch", "gf", "sdf", "tf", "vt", "pcp", "usd", "usdGeom", "usdUtils", "isaacsim.util.debug_draw.primitive_drawing"}
