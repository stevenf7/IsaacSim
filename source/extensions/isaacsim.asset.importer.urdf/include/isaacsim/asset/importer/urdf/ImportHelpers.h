...
void mergeFixedChildLinks(const KinematicChain::Node& parentNode, UrdfRobot& robot, bool ignoreInertia = false);
bool collapseFixedJoints(UrdfRobot& robot, bool ignoreInertia = false);
