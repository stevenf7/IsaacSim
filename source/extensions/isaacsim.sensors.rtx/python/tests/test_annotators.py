    ...
    async def _test_material_id(self):
        ...
        for i, (material_id, prim_path) in enumerate(zip(self.materialId, self.cube_prim_paths)):
            ...
            self.assertEqual(
                ...
                material_id,
                f"Expected material id {self.cube_info[prim_path]['material_id']} for return generated by {prim_path}, got {material_id} with attributes {decode_material_id(material_id)}.",
            )
