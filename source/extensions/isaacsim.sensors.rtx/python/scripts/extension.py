...
class Extension(omni.ext.IExt):
    ...
    def register_nodes(self):
        ...
        register_annotator_from_node_with_telemetry(
            ...
            node_type_id="isaacsim.sensors.rtx.IsaacReadRTXLidarData",
        )
        ...
        register_annotator_from_node_with_telemetry(
            name=annotator_name,
            input_rendervars=["RtxSensorCpu" + "Ptr"],
            node_type_id="isaacsim.sensors.rtx.IsaacComputeRTXLidarPointCloud",
        ...
        register_annotator_from_node_with_telemetry(
            name=annotator_name,
            input_rendervars=["RtxSensorCpu" + "Ptr"],
            node_type_id="isaacsim.sensors.rtx.IsaacRTXLidarOutput",
            output_data_type=np.float32,
            output_channels=3,
        )
        self.registered_annotators.append(annotator_name)
        ...
        register_node_writer_with_telemetry(
            ...
            node_type_id="isaacsim.sensors.rtx.IsaacPrintRTXSensorInfo",
        ...
        register_annotator_from_node_with_telemetry(
            name=annotator_name,
            input_rendervars=["RtxSensorCpu" + "Ptr"],
            node_type_id="isaacsim.sensors.rtx.IsaacComputeRTXRadarPointCloud",
            output_data_type=np.float32,
            output_channels=3,
        )
        self.registered_annotators.append(annotator_name)
