...
"""Tool to generate Ouster OS1 Lidar sensor JSON configuration files.

This script generates JSON configuration files for the Ouster OS1 32-channel Lidar sensor
