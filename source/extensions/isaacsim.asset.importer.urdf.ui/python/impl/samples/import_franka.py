...
class Extension(omni.ext.IExt):
    def on_startup(self, ext_id: str):
        ...
        core_ext_id = ext_manager.get_enabled_extension_id("isaacsim.asset.importer.urdf")
        self._urdf_data_path = ext_manager.get_extension_path(core_ext_id)
    ...
    async def _load_franka(self, task):
        ...
        if task in done:
            ...
            omni.kit.commands.execute(
                ...
                urdf_path=self._urdf_data_path + "/data/urdf/robots/franka_description/robots/panda_arm_hand.urdf",
