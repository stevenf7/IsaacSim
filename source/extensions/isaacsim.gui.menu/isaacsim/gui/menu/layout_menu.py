        ...
        self.__menu_layout = [
            MenuLayout.Menu(
                ...
                [
                    ...
                    MenuLayout.Item("Default Layout", source="Layout/Reset Layout"),
                    MenuLayout.Item("Visual Scripting", source="Layout/Visual Scripting"),
                    MenuLayout.Seperator(),
                    MenuLayout.Item("Save Layout", source="Window/Layout/Save Layout..."),
                    MenuLayout.Item("Load Layout", source="Window/Layout/Load Layout..."),
                    MenuLayout.Seperator(),
                    MenuLayout.Item("Quick Save", source="Layout/Quick Save"),
                    MenuLayout.Item("Quick Load", source="Layout/Quick Load"),
                ],
            )
        ]
