...
local ext_name = "occupancy_map"
local ext_version = ""
local ext_id = "omni.isaac.occupancy_map"
...
group ("extensions/"..ext_id)
    ...
    if os.target() == "windows" then
        project "omni.isaac.occupancy_map"
            kind "None"
            add_impl_folder("source/extensions/omni.isaac/occupancy_map/python")
    end

    repo_build.prebuild_link {
        { ext_source.."/config", ext_folder.."/config" },
        { ext_source.."/python/scripts", ext_folder.."/omni/isaac/occupancy_map/scripts" },
    }

    repo_build.prebuild_copy {
        { ext_source.."/python/*.py", ext_folder.."/omni/isaac/occupancy_map" },
        { "%{root}/_build/target-deps/octomap/lib/**", ext_bin_folder },
    }

    -- C++ Carbonite plugin
    project "omni.isaac.occupancy_map.plugin"
        ...
        add_iface_folder("%{root}/include/omni/isaac/occupancy_map")
        ...
        includedirs { 
            ...
            target_deps_dir.."/octomap/include",
        ...
        libdirs {               
            ...
            target_deps_dir.."/octomap/lib"
        }
        links {
            "ar", "arch", "gf", "js", "kind", "pcp", "plug", "sdf", "tf", "trace", "usd", "usdGeom", "usdShade", "vt", "work", "pxOsd",
            "hdx", "hd", "usdImaging", "hdSt", "usdLux", "usdUtils", "octomap", "omni.usd", "physicsSchema",
    ...
    project "omni.isaac.occupancy_map.python"
        define_bindings_python("_occupancy_map")
        add_impl_folder("bindings")
        targetdir (target_dir.."/exts/"..ext_id.."/omni/isaac/occupancy_map")
