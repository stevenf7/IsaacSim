...
struct RosGlobals
{
    ...
    carb::dictionary::ISerializer* json_serializer = nullptr;
    carb::dictionary::IDictionary* idict = nullptr;
    omni::isaac::dynamic_control::DynamicControl* dynamic_control = nullptr;
    double stageUnits = 1;
    double clock = 0;
};
...
struct RosActor
{
    omni::isaac::dynamic_control::DcObjectType type = omni::isaac::dynamic_control::eDcObjectNone;
    omni::isaac::dynamic_control::DcHandle handle = omni::isaac::dynamic_control::kDcInvalidHandle;
    pxr::UsdPrim prim;
};
