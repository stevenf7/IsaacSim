...
## Setup
- `cd to _build/linux-x86_64/release/exts/omni.isaac.samples/omni/isaac/samples/scripts/jetracer`
LOCMOD revisit python 3.7 or 3.6
- `conda create -n isaac python=3.6`
- `conda activate isaac`
- `pip install -r requirements.txt`
Go into the syntheticdata folder and run (needed only once)
- `export CUDA_HOME=CHANGE_TO_YOUR_PATH/omni_isaac_sim/_build/target-deps/cuda`
- `python setup.py install`
Then return back to jetracer and run
