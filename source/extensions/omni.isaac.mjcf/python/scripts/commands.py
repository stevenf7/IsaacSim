...
class MJCFCreateAsset(omni.kit.commands.Command):
    ...
    def __init__(self, mjcf_path: str = "", import_config=_mjcf.ImportConfig(), prim_path: str = "") -> None:
    ...
    def do(self) -> str:
        ...
        return self._mjcf_interface.create_asset_mjcf(self._mjcf_path, self.prim_path, self._import_config)
