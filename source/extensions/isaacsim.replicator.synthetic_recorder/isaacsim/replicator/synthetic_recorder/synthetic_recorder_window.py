...
PARAM_TOOLTIPS = {
    ...
    "distance_to_image_plane": "Outputs a depth map from objects to the image plane of the camera.\nProduces a 2d array of type np.float32 with 1 channel.",
...
class SyntheticRecorderWindow(ui.Window):
    def __init__(self, ext_id):
        super().__init__("Synthetic Data Recorder", dockPreference=ui.DockPreference.RIGHT_BOTTOM)
        self._visiblity_changed_listener = None
        self._ext_id = ext_id

        # Set the window dock location
        ...
        # Stop the recorder when the stage is closing
        ...
        # Stop the recorder and save config files when the editor is closed
        self._sub_shutdown = (
        ...
        # Default (BasicWriter) writer parameters
