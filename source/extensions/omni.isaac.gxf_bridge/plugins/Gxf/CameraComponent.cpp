...
//             // Set camera intrinsics value
//             setIntrinsics(message.intrinsics_info, message.distortion_info, depthInfo, focalLength,
//             horizontalAperture,
//                           verticalAperture, distortionCoefficients, projectionType);
//             // Set pose frame uid
//             message.pose_frame_uid->uid = poseUid;
...
//         if (segmentationInfo.tex.height != semanticInfo.tex.height || segmentationInfo.tex.width !=
//         semanticInfo.tex.width)
//         {
...
//                 publish(mSegmentationOutputComponent, mSegmentationChannelName + "_class",
//                 std::move(message.entity));
//             }
//         }
...
//             //
//             //            labels_timestamp.value()->acqtime = this->mTimeNanoSeconds +
//             mComponentTimeOffsetNanoSeconds;
...
//     const pxr::RobotEngineBridgeSchemaRobotEngineCamera& typedPrim =
//     (pxr::RobotEngineBridgeSchemaRobotEngineCamera)mPrim;
