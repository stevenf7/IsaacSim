...
SETTINGS_PATH = "/persistent/exts/isaacsim.asset.generator.conveyor.ui.settings"
...
class ConveyorBuilderPreferences(PreferenceBuilder):
    ...
    def reset_config_default(self):
        ...
        ext_id = ext_manager.get_enabled_extension_id("isaacsim.asset.generator.conveyor.ui")
