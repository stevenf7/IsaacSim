...
local ogn = get_ogn_project_information(ext, "isaacsim/ros1/bridge")

project_ext (ext)
-- C++ Carbonite plugin
project_ext_plugin(ext, "isaacsim.ros1.bridge.plugin")
    ...
    includedirs {
        ...
        "%{root}/source/extensions/isaacsim.ros1.bridge",
        ...
        "%{root}/source/extensions/isaacsim.ros1.bridge/include",
...
project_ext_bindings {
    ext = ext,
    project_name = "isaacsim.ros1.bridge.python",
    module = "_ros_bridge",
    src = "bindings",
    target_subdir = "isaacsim/ros1/bridge"
}
...
repo_build.prebuild_link {
    { "python/scripts", ext.target_dir.."/isaacsim/ros1/bridge/scripts" },
    { "python/tests", ext.target_dir.."/isaacsim/ros1/bridge/tests" },
...
repo_build.prebuild_copy {
    { "python/*.py", ext.target_dir.."/isaacsim/ros1/bridge" },
