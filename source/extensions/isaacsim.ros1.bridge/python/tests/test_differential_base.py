    ...
    async def test_differential_base(self):
        ...
        try:
            og.Controller.edit(
                graph_path,
                {
                    og.Controller.Keys.CREATE_NODES: [("PublishTF", "isaacsim.ros1.bridge.ROS1PublishTransformTree")],
            ...
            (graph, nodes, _, _) = og.Controller.edit(
                {"graph_path": graph_path, "evaluator_name": "execution"},
                {
                    keys.CREATE_NODES: [
                        ...
                        ("publishRawTF", "isaacsim.ros1.bridge.ROS1PublishRawTransformTree"),
                        # Added nodes used for Twist subscriber, differential drive
                        ("subscribeTwist", "isaacsim.ros1.bridge.ROS1SubscribeTwist"),
