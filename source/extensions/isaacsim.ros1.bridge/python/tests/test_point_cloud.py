            ...
            (graph, nodes, _, _) = og.Controller.edit(
                {"graph_path": graph_path, "evaluator_name": "execution"},
                {
                    keys.CREATE_NODES: [
                        ...
                        ("PublishPCL", "isaacsim.ros1.bridge.ROS1PublishPointCloud"),
                    ],
                    keys.SET_VALUES: [
            ...
            (graph, nodes, _, _) = og.Controller.edit(
                {"graph_path": graph_path, "evaluator_name": "execution"},
                {
                    keys.CREATE_NODES: [
                        ...
                        ("ReadLidarPCL", "isaacsim.sensors.physx.IsaacReadLidarPointCloud"),
                        ("PublishPCL", "isaacsim.ros1.bridge.ROS1PublishPointCloud"),
                        ("CameraHelper", "isaacsim.ros1.bridge.ROS1CameraHelper"),
                    ],
                    keys.SET_VALUES: [
    ...
    async def test_depth_to_point_cloud(self):
        ...
        try:
            ...
            (graph, nodes, _, _) = og.Controller.edit(
                graph_path,
                {
                    keys.CREATE_NODES: [("depthToPCL", "isaacsim.ros1.bridge.ROS1CameraHelper")],
                    keys.CONNECT: [
