...
class TestRosCamera(omni.kit.test.AsyncTestCase):
    ...
    async def setUp(self):
        ...
        ext_id = ext_manager.get_enabled_extension_id("isaacsim.ros1.bridge")
            ...
            og.Controller.edit(
                {"graph_path": "/ActionGraph", "evaluator_name": "execution"},
                {
                    og.Controller.Keys.CREATE_NODES: [
                        ...
                        ("RGBPublish", "isaacsim.ros1.bridge.ROS1CameraHelper"),
                        ("DepthPublish", "isaacsim.ros1.bridge.ROS1CameraHelper"),
                        ("DepthPclPublish", "isaacsim.ros1.bridge.ROS1CameraHelper"),
                        ("InstancePublish", "isaacsim.ros1.bridge.ROS1CameraHelper"),
                        ("SemanticPublish", "isaacsim.ros1.bridge.ROS1CameraHelper"),
                        ("Bbox2dTightPublish", "isaacsim.ros1.bridge.ROS1CameraHelper"),
                        ("Bbox2dLoosePublish", "isaacsim.ros1.bridge.ROS1CameraHelper"),
                        ("Bbox3dPublish", "isaacsim.ros1.bridge.ROS1CameraHelper"),
                        ("CameraInfoPublish", "isaacsim.ros1.bridge.ROS1CameraHelper"),
                    ],
