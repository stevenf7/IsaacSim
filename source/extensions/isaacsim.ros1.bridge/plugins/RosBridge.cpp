...
const struct carb::PluginImplDesc kPluginImpl = { "isaacsim.ros1.bridge.plugin", "Isaac ROS bridge", "NVIDIA",
                                                  carb::PluginHotReload::eDisabled, "dev" };

CARB_PLUGIN_IMPL(kPluginImpl, isaacsim::ros1::bridge::RosBridge)
...
CARB_EXPORT void carbOnPluginStartup()
{
    ...
    settings->setDefaultString("/exts/isaacsim.ros1.bridge/nodeName", "OmniIsaacRosBridge");
    std::string nodeName = settings->get<const char*>("/exts/isaacsim.ros1.bridge/nodeName");
    if (nodeName.size() == 0)
    {
...
void fillInterface(isaacsim::ros1::bridge::RosBridge& iface)
{
