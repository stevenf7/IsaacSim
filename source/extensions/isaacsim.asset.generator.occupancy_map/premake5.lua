...
local ogn = get_ogn_project_information(ext, "isaacsim/asset/generator/occupancy_map")
project_ext (ext)


project_with_location("isaacsim.asset.generator.occupancy_map.generator")
...
-- C++ Carbonite plugin
project_ext_plugin(ext, "isaacsim.asset.generator.occupancy_map.plugin")
    dependson {"isaacsim.asset.generator.occupancy_map.generator"}
    ...
    links {"usdUtils", "omni.usd", "isaacsim.util.debug_draw.primitive_drawing", "usdPhysics", "isaacsim.asset.generator.occupancy_map.generator", "sdf", "tf", "usd"}
    filter { "system:linux" }
        disablewarnings {"error=pragmas"}
        includedirs {
...
project_ext_bindings ({
    ext = ext,
    project_name = "isaacsim.asset.generator.occupancy_map.python",
    ...
    links {"sdf", "tf", "usd", "usdUtils", "usdPhysics", "isaacsim.asset.generator.occupancy_map.generator"}
