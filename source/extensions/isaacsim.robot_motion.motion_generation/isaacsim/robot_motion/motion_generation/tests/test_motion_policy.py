...
class TestMotionPolicy(omni.kit.test.AsyncTestCase):
    ...
    async def test_rmpflow_on_franka(self):
        ...
        ground_truths = {
            "no_target": np.array([-0.00471133, -0.2752474, 0.00082409, 0.03296495, 0.0023745, -0.4330765, 0.00230568]),
            "target_no_obstacle": np.array(
                [0.2208734, -0.27472493, 0.20527047, 0.01466327, -0.02918294, -0.43729705, 0.00293894]
            ),
            "target_with_obstacle": np.array(
                [-0.01778729, -0.22939391, -0.21089812, -0.06849217, -0.15353785, -0.1649279, -0.00915851]
            ),
