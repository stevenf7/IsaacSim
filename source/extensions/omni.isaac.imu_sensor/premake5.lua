...
-- C++ Carbonite plugin
project_ext_plugin(ext, "omni.isaac.imu_sensor.plugin")
    dependson { "prebuild", "carb.physics-usd.plugin", "omni.physx.plugin" }
    add_files("impl", "plugins")
    add_files("iface", "%{root}/include/omni/isaac/imu_sensor/**")
...
project_ext_bindings {
    ext = ext,
    project_name = "omni.isaac.imu_sensor.python",
    module = "_imu_sensor",
    src = "bindings",
    target_subdir = "omni/isaac/imu_sensor"
}

repo_build.prebuild_link {
    { "python/scripts", ext.target_dir.."/omni/isaac/imu_sensor/scripts" },
    { "python/tests", ext.target_dir.."/omni/isaac/imu_sensor/tests" },
    { "data", ext.target_dir.."/data" },
    { "docs", ext.target_dir.."/docs" },
}

repo_build.prebuild_copy {
    { "python/*.py", ext.target_dir.."/omni/isaac/imu_sensor" },
}
