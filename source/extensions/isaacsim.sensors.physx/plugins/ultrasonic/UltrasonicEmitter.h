...
class UltrasonicEmitter : public omni::isaac::utils::ComponentBase<pxr::RangeSensorUltrasonicEmitter>
{
public:
    UltrasonicEmitter()
    {
    ...
    void updatePose()
    {
        ...
        mOrigin = omni::isaac::utils::conversions::asPxVec3(worldMat.ExtractTranslation());
        mTheta0 = omni::isaac::utils::conversions::asPxQuat(worldMat.ExtractRotation());
    }
    ...
    {
        omni::isaac::utils::ComponentBase<pxr::RangeSensorUltrasonicEmitter>::initialize(prim, stage);
    ...
    void onComponentChange()
    {
        ...
        omni::isaac::utils::safeGetAttribute(mPrim.GetYawOffsetAttr(), mYawOffset);
        omni::isaac::utils::safeGetAttribute(mPrim.GetPerRayIntensityAttr(), mPerRayIntensity);
        omni::isaac::utils::safeGetAttribute(mPrim.GetAdjacencyListAttr(), mAdjacencyList);
