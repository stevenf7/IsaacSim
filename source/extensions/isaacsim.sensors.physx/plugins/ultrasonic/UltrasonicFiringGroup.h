...
class UltrasonicFiringGroup : public omni::isaac::utils::ComponentBase<pxr::RangeSensorUltrasonicFiringGroup>
{
public:
    ...
    {
        omni::isaac::utils::ComponentBase<pxr::RangeSensorUltrasonicFiringGroup>::initialize(prim, stage);
    ...
    {
        omni::isaac::utils::safeGetAttribute(mPrim.GetEmitterModesAttr(), mEmitterModes);
        omni::isaac::utils::safeGetAttribute(mPrim.GetReceiverModesAttr(), mReceiverModes);
