...
CARB_PLUGIN_IMPL(kPluginImpl,
                 ...
                 isaacsim::sensors::physx::UltrasonicSensorInterface,
...
bool CARB_ABI isUltrasonicSensor(const char* primPath)
{
    ...
    if (g_stage && gRangeSensorManager)
    {
        isaacsim::sensors::physx::UltrasonicSensor* sensor =
...
void fillInterface(isaacsim::sensors::physx::UltrasonicSensorInterface& iface)
{
    using namespace isaacsim::sensors::physx;
    memset(&iface, 0, sizeof(iface));
