...
{
inline omni::isaac::dynamic_control::DcTransform asDcTransform(const geometry_msgs::msg::Pose& p, const float scale = 1)
{
...
inline omni::isaac::dynamic_control::DcTransform asDcTransform(const geometry_msgs::msg::Transform& p,
                                                               const float scale = 1)
{
    omni::isaac::dynamic_control::DcTransform t;
...
inline geometry_msgs::msg::Pose asRosPose(const omni::isaac::dynamic_control::DcTransform& trans, const float scale = 1)
{
...
inline geometry_msgs::msg::Pose asRosPose(const pxr::GfTransform& trans, const float scale = 1)
{
    geometry_msgs::msg::Pose p;
...
inline geometry_msgs::msg::Transform asRosTransform(const omni::isaac::dynamic_control::DcTransform& trans,
                                                    const float scale = 1)
{
    geometry_msgs::msg::Transform p;
...
inline geometry_msgs::msg::Transform asRosTransform(const physx::PxTransform& trans, const float scale = 1)
{
    geometry_msgs::msg::Transform p;
...
inline geometry_msgs::msg::Transform asRosTransform(const pxr::GfTransform& trans, const float scale = 1)
{
    geometry_msgs::msg::Transform p;
    const pxr::GfVec3d pos = trans.GetTranslation() * scale;
    const pxr::GfQuatd rot = trans.GetRotation().GetQuat();
