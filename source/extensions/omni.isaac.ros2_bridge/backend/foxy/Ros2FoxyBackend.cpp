...
void Ros2BackendFoxy::set_string(const std::string& input, rosidl_runtime_c__String& output)
{
    rosidl_runtime_c__String__assign(&output, input.c_str());
}

void Ros2BackendFoxy::set_header(const std::string& frame_id, const int64_t nanoseconds, std_msgs__msg__Header& header)
{
