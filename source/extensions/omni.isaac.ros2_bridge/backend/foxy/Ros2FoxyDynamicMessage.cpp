...
const nlohmann::json& Ros2DynamicMessageFoxy::getData()
{
    const void* members = getIntrospectionMembers();
...
const std::vector<std::shared_ptr<void>>& Ros2DynamicMessageFoxy::getData(bool asOgnType)
{
    size_t index = 0;
    const void* members = getIntrospectionMembers();
    if (members)
...
void Ros2DynamicMessageFoxy::setData(const nlohmann::json& data)
{
    const void* members = getIntrospectionMembers();
    if (members)
...
void Ros2DynamicMessageFoxy::setData(const std::vector<std::shared_ptr<void>>& data, bool fromOgnType)
{
    size_t index = 0;
    const void* members = getIntrospectionMembers();
    if (members)
...
std::string Ros2DynamicMessageFoxy::summary(bool print)
{
    // backend type
...
void Ros2DynamicMessageFoxy::getArrayEmbeddedMessage(const rosidl_typesupport_introspection_c__MessageMember* member,
                                                     uint8_t* data,
                                                     nlohmann::json& array)
{
...
void Ros2DynamicMessageFoxy::setArrayEmbeddedMessage(const rosidl_typesupport_introspection_c__MessageMember* member,
                                                     uint8_t* data,
...
void Ros2DynamicMessageFoxy::getArray(const rosidl_typesupport_introspection_c__MessageMember* member,
                                      uint8_t* data,
...
void Ros2DynamicMessageFoxy::getSingleValue(uint8_t* data, std::shared_ptr<void>& valuePtr, bool asOgnType)
{
...
template <typename RosType, typename OgnType>
void Ros2DynamicMessageFoxy::setSingleValue(uint8_t* data, const std::shared_ptr<void>& valuePtr, bool fromOgnType)
{
    if (fromOgnType)
...
void Ros2DynamicMessageFoxy::getMessageValues(const void* members, uint8_t* messageData, nlohmann::json& container)
{
    auto messageMembers = reinterpret_cast<const rosidl_typesupport_introspection_c__MessageMembers*>(members);
    for (size_t i = 0; i < messageMembers->member_count_; ++i)
    {
...
void Ros2DynamicMessageFoxy::getMessageValues(const void* members,
                                              uint8_t* messageData,
...
void Ros2DynamicMessageFoxy::setMessageValues(const void* members, uint8_t* messageData, const nlohmann::json& container)
{
