...
#include <rcl/rcl.h>
Ros2PublisherFoxy::Ros2PublisherFoxy(Ros2NodeBase* node, const char* topic_name, const void* type, const Ros2QoSProfile& qos)
    : mNode(node)
{
    ...
    pub_opt.qos = Ros2QoSProfileFoxyConverter::convert(qos);
