...
public:
    ...
    bool serviceServer(OgnROS2ServiceServerResponseDatabase& db, const GraphContextObj& context)
    {
        ...
        omni::isaac::omnigraph_utils::writeMessageDataFromNode(db, state.m_messageResponse, "Response:", false);
...
private:
                         ...
                         std::string messageName)
    {
        ...
        omni::isaac::omnigraph_utils::createOgAttributesForMessage<OgnROS2ServiceServerResponseDatabase, false, false>(
