...
"""Provides a Python code executor for running statements and expressions in VS Code integration."""
...
class Executor:
    ...
    def _get_compiler_flags(self) -> int:
        ...
        Returns:
            The combined compiler flags including future feature flags and top-level await support.
        """
        flags = 0
    ...
    def _get_coroutine_flag(self) -> int:
        ...
        Returns:
            The compiler flag value for coroutines, or -1 if not found.
        """
    ...
    async def execute(self, source: str) -> tuple[str, Exception | None, str]:
        ...
        Args:
            source: Statement or expression to execute.
