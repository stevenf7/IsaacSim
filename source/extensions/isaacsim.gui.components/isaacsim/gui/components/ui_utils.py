...
def setup_ui_headers(
    ...
    doc_link="https://omniverse.gitlab-master-pages.nvidia.com/isaac/isaacsim-docs/index.html",
    overview="",
    info_collapsed=True,
):
    ...
    Args:
        ...
        doc_link (str, optional): Hyperlink to Documentation. Defaults to "https://omniverse.gitlab-master-pages.nvidia.com/isaac/isaacsim-docs/index.html".
