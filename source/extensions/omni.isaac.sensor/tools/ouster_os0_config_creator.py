...
#
# This is an example configuration file creator for the Ouster OS0 Lidar with 128 channels.
brand = "ouster"
model = "OS0"
channels = 128
...
for config in configs:
    ...
    with open(file_name, "w") as f:
        ...
        print("        ")
        print(
            f'        "upElevationDeg": 45.0, {comment("OPTICAL PERFORMANCE- Field of View Vertical: 90° (+45° to -45°)")},'
        )
        print('        "downElevationDeg": -45.0,')
        print("        ")
