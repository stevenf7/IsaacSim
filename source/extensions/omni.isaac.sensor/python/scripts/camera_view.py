...
class CameraView(XFormPrimView):
    def __init__(
        ...
        self._tiled_rgb_annotator = None
        self._tiled_annotator = None
        self._tiled_depth_annotator = None
    ...
    def _clean_up_tiled_sensor(self):
        ...
        if self._tiled_render_product is not None:
            ...
            self._tiled_rgb_annotator.detach([self._tiled_render_product.path])
            self._tiled_depth_annotator.detach([self._tiled_render_product.path])
        ...
        if self._tiled_sensor is not None:
            ...
            for name, prim_path in self._tiled_sensor.get_input_prims().items():
