...
"""Validate RectLight wrapping and rectangle-light USD attributes.

The suite authors existing rect light prims for wrap-mode tests, verifies type
detection and collection length, and round-trips width, height, and texture
file attributes through indexed get/set calls.
"""
...
class TestRectLight(omni.kit.test.AsyncTestCase):
    """Exercise RectLight type checks and size or texture attributes."""
