...
"""Validate Sphere wrapping and sphere-specific USD attributes.

The suite authors existing sphere prims for wrap-mode tests, verifies USD geom
binding and collection length, and round-trips radius values through indexed
get/set calls.
"""
...
class TestSphere(omni.kit.test.AsyncTestCase):
    """Exercise Sphere geometry checks and radius authoring."""
