...
"""Validate Capsule wrapping and capsule-specific USD attributes.

The suite authors existing capsule prims for wrap-mode tests, verifies USD
...
class TestCapsule(omni.kit.test.AsyncTestCase):
    """Exercise Capsule geometry checks and authored shape attributes."""
