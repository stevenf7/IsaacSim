...
class TestBenchmarkRobotsCarter(BaseIsaacBenchmark):
    ...
    async def test_benchmark_1_robot_carter(self):
        await self.benchmark_robots(1)

    async def test_benchmark_5_robot_carter(self):
        await self.benchmark_robots(5)

    async def test_benchmark_10_robot_carter(self):
        await self.benchmark_robots(10)

    async def test_benchmark_25_robot_carter(self):
        await self.benchmark_robots(25)

    async def test_benchmark_50_robot_carter(self):
        await self.benchmark_robots(50)

    async def test_benchmark_1_robot_carter_lidar(self):
        await self.benchmark_robots(1, True)

    async def test_benchmark_5_robot_carter_lidar(self):
        await self.benchmark_robots(5, True)

    async def test_benchmark_10_robot_carter_lidar(self):
        await self.benchmark_robots(10, True)

    async def test_benchmark_1_robot_carter_camera(self):
        await self.benchmark_robots(1, False, True)

    async def test_benchmark_5_robot_carter_camera(self):
        await self.benchmark_robots(5, False, True)

    async def test_benchmark_10_robot_carter_camera(self):
        await self.benchmark_robots(10, False, True)

    async def test_benchmark_1_robot_carter_lidar_camera(self):
        await self.benchmark_robots(1, True, True)

    async def test_benchmark_5_robot_carter_lidar_camera(self):
        await self.benchmark_robots(5, True, True)

    async def test_benchmark_10_robot_carter_lidar_camera(self):
