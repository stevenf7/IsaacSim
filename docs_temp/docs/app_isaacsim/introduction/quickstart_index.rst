...
.. _isaac_sim_intro_quickstart_series:

==================================
Quick Tutorials  
==================================

If you are new to |isaac-sim|, we recommend that you review the GUI references and complete the two tutorials listed below.
...
If you are new to |isaac-sim| and want to learn how to set up and rig robots, we **strongly recommend** exploring our comprehensive :ref:`Robot Setup Tutorials <isaac_sim_robot_setup_tutorials>`. These tutorials will teach you:
...
**Start here:** :ref:`Tutorial 1: Stage Setup <isaac_sim_app_tutorial_intro_environment_setup>`
...
- **Examples and Demos:** Access a library of examples and demos in :ref:`Examples <isaac_sim_app_intro_examples>` to explore use-cases and capabilities of |isaac-sim|
- **Available Assets:** Browse the :ref:`Assets <isaac_assets_overview>` section to see what assets are available to you
- **Advanced Python API:** See :ref:`Build a Robot using Core Python API <isaac_sim_core_api_tutorials_page>` for more complex tutorials
