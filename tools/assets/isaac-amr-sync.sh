...
echo run $OMNICLI copy omniverse://isaac-dev.ov.nvidia.com/Isaac/Samples/Isaac_AMR/2.1 $SCRIPT_DIR/Isaac_AMR
$OMNICLI copy omniverse://isaac-dev.ov.nvidia.com/Isaac/Samples/Isaac_AMR/2.1 $SCRIPT_DIR/Isaac_AMR
