...
class runtime:
    ...
    packmans = {"windows": os.path.join(packman_path, "packman.cmd"), "linux": os.path.join(packman_path, "packman")}

    deps = {"repoman": None, "pip": None, "packman": None, "packman-common": None}
