...
$OMNICLI copy omniverse://isaac-dev.ov.nvidia.com/NVIDIA/Materials/Base $SCRIPT_DIR/../../../../_assets_temp/NVIDIA/Materials/Base
...
$OMNICLI copy omniverse://isaac-dev.ov.nvidia.com/NVIDIA/Assets/Characters $SCRIPT_DIR/../../../../_assets_temp/NVIDIA/Assets/Characters
echo "##teamcity[progressMessage 'Downloading /NVIDIA/Assets/Particles/...']"
$OMNICLI copy omniverse://isaac-dev.ov.nvidia.com/NVIDIA/Assets/Particles $SCRIPT_DIR/../../../../_assets_temp/NVIDIA/Assets/Particles
echo "##teamcity[progressMessage 'Downloading /NVIDIA/Assets/Scenes/...']"
$OMNICLI copy omniverse://isaac-dev.ov.nvidia.com/NVIDIA/Assets/Scenes $SCRIPT_DIR/../../../../_assets_temp/NVIDIA/Assets/Scenes
echo "##teamcity[progressMessage 'Downloading /NVIDIA/Assets/Skies/...']"
$OMNICLI copy omniverse://isaac-dev.ov.nvidia.com/NVIDIA/Assets/Skies $SCRIPT_DIR/../../../../_assets_temp/NVIDIA/Assets/Skies
echo "##teamcity[progressMessage 'Downloading /NVIDIA/Assets/Vegetation/...']"
$OMNICLI copy omniverse://isaac-dev.ov.nvidia.com/NVIDIA/Assets/Vegetation $SCRIPT_DIR/../../../../_assets_temp/NVIDIA/Assets/Vegetation

echo "##teamcity[progressMessage 'Downloading /Isaac/Environments/...']"
$OMNICLI copy omniverse://isaac-dev.ov.nvidia.com/Isaac/Environments $SCRIPT_DIR/../../../../_assets_temp/Isaac/Environments
echo "##teamcity[progressMessage 'Downloading /Isaac/Materials/...']"
$OMNICLI copy omniverse://isaac-dev.ov.nvidia.com/Isaac/Materials $SCRIPT_DIR/../../../../_assets_temp/Isaac/Materials
echo "##teamcity[progressMessage 'Downloading /Isaac/People/...']"
$OMNICLI copy omniverse://isaac-dev.ov.nvidia.com/Isaac/People $SCRIPT_DIR/../../../../_assets_temp/Isaac/People
echo "##teamcity[progressMessage 'Downloading /Isaac/Props/...']"
$OMNICLI copy omniverse://isaac-dev.ov.nvidia.com/Isaac/Props $SCRIPT_DIR/../../../../_assets_temp/Isaac/Props
