...
$OMNICLI copy omniverse://ov-isaac-dev.nvidia.com/NVIDIA/Assets/Characters $SCRIPT_DIR/../../../../_assets_temp/NVIDIA/Assets/Characters
echo "##teamcity[progressMessage 'Downloading /NVIDIA/Assets/Particles/...']"
$OMNICLI copy omniverse://ov-isaac-dev.nvidia.com/NVIDIA/Assets/Particles $SCRIPT_DIR/../../../../_assets_temp/NVIDIA/Assets/Particles
echo "##teamcity[progressMessage 'Downloading /NVIDIA/Assets/Scenes/...']"
$OMNICLI copy omniverse://ov-isaac-dev.nvidia.com/NVIDIA/Assets/Scenes $SCRIPT_DIR/../../../../_assets_temp/NVIDIA/Assets/Scenes
