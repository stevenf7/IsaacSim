...
REM call "%~dp0..\..\..\build_docs.bat" -c debug
...
REM call "%~dp0..\..\..\package.bat" -m omniverse-kit-robotics -c debug
REM if %errorlevel% neq 0 ( exit /b %errorlevel% )

REM echo ##teamcity[progressMessage 'Packaging omni_domain_randomization...']
REM call "%~dp0..\..\..\package.bat" -m omni_domain_randomization -c debug
REM if %errorlevel% neq 0 ( exit /b %errorlevel% )
