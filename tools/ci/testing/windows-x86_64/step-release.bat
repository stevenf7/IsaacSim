...
:: Python Tests - DX12
echo ##teamcity[testSuiteStarted name='omniverse-kit-robotics-pythontests-dx12-release']
call "%~dp0..\..\..\test_runner.bat" --suite pythontests --config release %package%
echo ##teamcity[testSuiteFinished name='omniverse-kit-robotics-pythontests-dx12-release']

:: Python Tests - Vulkan
echo ##teamcity[testSuiteStarted name='omniverse-kit-robotics-pythontests-vulkan-release']
call "%~dp0..\..\..\test_runner.bat" --suite pythontests --config release %package% -e="--vulkan"
echo ##teamcity[testSuiteFinished name='omniverse-kit-robotics-pythontests-vulkan-release']
